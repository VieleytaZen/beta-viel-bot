        ...
        case 'common':
            switch (jumlah) { 
                ...
                case 'crate':
                    ...
                    let _ce1 = `${Math.floor(Math.random() * 70)}`.trim()
...
`.trim()
                    ...
                    break
                case '100':
                    let _cm2 = `${Math.floor(Math.random() * 500)}`.trim()
                    let _cc2 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _cp2 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _ce2 = `${Math.floor(Math.random() * 750)}`.trim()
                    let _cu2 = `${Math.floor(Math.random() * 3)}`.trim()
                    let cm2 = (_cm2 * 1)
                    let cc2 = (_cc2 * 1)
                    let cp2 = (_cp2 * 1)
                    let ce2 = (_ce2 * 1)
...
`.trim()
                    ...
                    break
                case '1000':
                    let _cm3 = `${Math.floor(Math.random() * 5000)}`.trim()
                    let _cc3 = `${Math.floor(Math.random() * 35)}`.trim()
                    let _cp3 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _ce3 = `${Math.floor(Math.random() * 8000)}`.trim()
                    let _cu3 = `${Math.floor(Math.random() * 20)}`.trim()
                    let cm3 = (_cm3 * 1)
                    let cc3 = (_cc3 * 1)
                    let cp3 = (_cp3 * 1)
                    let ce3 = (_ce3 * 1)
        ...
        case 'uncommon':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    let _ue1 = `${Math.floor(Math.random() * 75)}`.trim()
                    let _um1 = `${Math.floor(Math.random() * 40)}`.trim()
                    let _up1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _umc1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _uu1 = `${Math.floor(Math.random() * 3)}`.trim()
...
`.trim()
                    ...
                    break
                case '100':
                    let _ud2 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _ue2 = `${Math.floor(Math.random() * 800)}`.trim()
                    let _um2 = `${Math.floor(Math.random() * 500)}`.trim()
                    let _up2 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _umc2 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _uu2 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _uc2 = `${Math.floor(Math.random() * 5)}`.trim()
                    let ud2 = (_ud2 * 1)
                    let ue2 = (_ue2 * 1)
                    let um2 = (_um2 * 1)
                    let up2 = (_up2 * 1)
...
`.trim()
                    ...
                    break
                case '1000':
                    let _ud3 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _ue3 = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _um3 = `${Math.floor(Math.random() * 5000)}`.trim()
                    let _up3 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _umc3 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _uu3 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _uc3 = `${Math.floor(Math.random() * 20)}`.trim()
                    let ud3 = (_ud3 * 1)
                    let ue3 = (_ue3 * 1)
                    let um3 = (_um3 * 1)
                    let up3 = (_up3 * 1)
...
`.trim()
        ...
        case 'mythic':
            switch (jumlah) {
                case '10':
                case 'crate':
                    let _mm1 = `${Math.floor(Math.random() * 200)}`.trim()
                    let _mmm1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _me1 = `${Math.floor(Math.random() * 300)}`.trim()
                    let _mp1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _mu1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _mc1 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _ml1 = `${Math.floor(Math.random() * 3)}`.trim()
...
`.trim()
                    ...
                    break
                case '100':
                    let _mm2 = `${Math.floor(Math.random() * 2500)}`.trim()
                    let _mmm2 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _me2 = `${Math.floor(Math.random() * 3000)}`.trim()
                    let _mp2 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _mu2 = `${Math.floor(Math.random() * 8)}`.trim()
                    let _mc2 = `${Math.floor(Math.random() * 15)}`.trim()
                    let _ml2 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _md2 = `${Math.floor(Math.random() * 2)}`.trim()
                    let mm2 = (_mm2 * 1)
                    let mmm2 = (_mmm2 * 1)
                    let me2 = (_me2 * 1)
                    let mp2 = (_mp2 * 1)
...
`.trim()
                ...
                case '1000':
                    ...
                    let _mmm3 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _me3 = `${Math.floor(Math.random() * 75000)}`.trim()
                    let _mp3 = `${Math.floor(Math.random() * 7)}`.trim()
                    let _mu3 = `${Math.floor(Math.random() * 25)}`.trim()
                    let _mc3 = `${Math.floor(Math.random() * 75)}`.trim()
                    let _ml3 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _md3 = `${Math.floor(Math.random() * 5)}`.trim()
                    let mm3 = (_mm3 * 1)
                    let mmm3 = (_mmm3 * 1)
                    let me3 = (_me3 * 1)
                    let mp3 = (_mp3 * 1)
...
`.trim()
        ...
        case 'legendary':
            switch (jumlah) {            
                case '10':
                case 'crate':
                    let _lm1 = `${Math.floor(Math.random() * 1000)}`.trim()
                    let _le1 = `${Math.floor(Math.random() * 1500)}`.trim()
                    let _lp1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _lu1 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _lc1 = `${Math.floor(Math.random() * 7)}`.trim()
                    let _ll1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _lpp1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _ld1 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _lmm1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let lm1 = (_lm1 * 1)
                    let le1 = (_le1 * 1)
                    let lp1 = (_lp1 * 1) 
                    let lu1 = (_lu1 * 1) 
...
`.trim()  
                    ...
                    break
                case '100':
                    let _lm2 = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _le2 = `${Math.floor(Math.random() * 20000)}`.trim()
                    let _lp2 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _lu2 = `${Math.floor(Math.random() * 25)}`.trim()
                    let _lc2 = `${Math.floor(Math.random() * 75)}`.trim()
                    let _ll2 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _lpp2 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _ld2 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _lmm2 = `${Math.floor(Math.random() * 2)}`.trim()
                    let lm2 = (_lm2 * 1)
                    let le2 = (_le2 * 1)
                    let lp2 = (_lp2 * 1) 
                    let lu2 = (_lu2 * 1) 
...
`.trim()  
                    ...
                    break
                case '1000':
                    let _lm3 = `${Math.floor(Math.random() * 200000)}`.trim()
                    let _le3 = `${Math.floor(Math.random() * 500000)}`.trim()
                    let _lp3 = `${Math.floor(Math.random() * 50)}`.trim()
                    let _lu3 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _lc3 = `${Math.floor(Math.random() * 250)}`.trim()
                    let _ll3 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _lpp3 = `${Math.floor(Math.random() * 22)}`.trim()
                    let _ld3 = `${Math.floor(Math.random() * 25)}`.trim()
                    let _lmm3 = `${Math.floor(Math.random() * 11)}`.trim()
                    let lm3 = (_lm3 * 1)
                    let le3 = (_le3 * 1)
                    let lp3 = (_lp3 * 1) 
                    let lu3 = (_lu3 * 1) 
